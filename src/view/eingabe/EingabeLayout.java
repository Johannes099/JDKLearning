...
public class EingabeLayout {
    ...
    private JTextField frage, antwort;
    private JLabel titleLabel;

    public EingabeLayout() {
        ...
        frage.setUI(new RoundedTextFieldUI(40));
    ...
    public JPanel buildPanel() {
        ...
        JLabel subtitle = new JLabel(
                "<html><div style='text-align:center;'>Geben Sie Frage und Antwort<br>für die erste Frage ein</div></html>",
    ...
    public JTextField getFrage() { return frage; }
